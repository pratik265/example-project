    ...
    <div className="ft-doctors-page">
      <section className="ft-section">
        <div className="ft-container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
            ...
            {doctors.map(doctor => {
              ...
              return (
                <div key={doctor.id} className="ft-card ft-doctor-card" style={{
                  ...
                  {doctor.image ? (
                    <div className="ft-doctor-image-container" style={{
                      width: '150px',
                      height: '150px',
                      borderRadius: '50%',
                      marginBottom: '1.5rem',
                  ...
                  <div className="ft-doctor-description" style={{
                    marginBottom: '1.5rem',
                    color: '#6c757d',
                    fontSize: '0.9rem',
                    flex: 1,
                  ...
                  {doctor.team_member_id && (
                    <div className="ft-team-id" style={{
                      marginBottom: '1rem',
                      color: '#6c757d',
                      fontSize: '0.9rem'
                    }}>
          ...
          {doctors.length === 0 && (
            <div className="ft-no-doctors-found" style={{textAlign: 'center', padding: '2rem'}}>
